//! Benchmark-modul for måling av kryptografisk ytelse og rammeprosessering.

use std::time::Instant;

use crate::crypto::{derive_session_keys, diffie_hellman, CipherState, KeyPair, KEY_LEN};
use crate::protocol::{MessageType, ReplayFilter, WireFrame};

/// Kjører den fullstendige ytelses- og throughput-benchmark-suiten.
